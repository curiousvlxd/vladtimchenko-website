<template>
  <Teleport to="body">
    <Transition name="testimonial-modal">
      ...
      >
        <div class="testimonial-modal-card card-gradient-animated rounded-2xl border border-teal/20 bg-[rgba(24,183,164,0.05)] relative max-w-2xl w-full max-h-[90vh] flex flex-col shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5),0_0_40px_-10px_rgba(24,183,164,0.15)]" @click.stop>
          <div class="overflow-y-auto flex-1 min-h-0 p-6 sm:p-8">
            <div class="flex justify-end mb-3">
              <button
                class="testimonial-modal-close w-8 h-8 rounded-lg bg-teal/10 border border-teal/20 text-muted-pale flex items-center justify-center cursor-pointer transition-all duration-200 hover:bg-teal/20 hover:border-teal/40 hover:text-teal shrink-0"
                @click="$emit('close')"
            ...
            <div class="flex items-center gap-2 min-w-0 mb-4 pb-3 border-b border-teal/20">
              <div
              ...
              <span class="text-[11px] font-medium text-muted-light uppercase tracking-wider leading-none">
            ...
            <div class="text-base text-muted-pale leading-relaxed mt-4">
              <p
            ...
            <div class="mt-5 pt-4 border-t border-teal/20 text-sm text-muted-light">
